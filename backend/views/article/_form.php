            ...
            <div class="ibox-content">
                <div class="row form-body form-horizontal m-t">
                    ...
                    <div class="col-md-5 droppable sortable ui-droppable ui-sortable" style="">
                        ...
                        <div class="ibox-content">
                            <?= $form->field($model, 'cid')->dropDownList(Category::getCategoriesName()); ?>
                        </div>
                    </div>
                    ...
                    <div class="col-md-5 droppable sortable ui-droppable ui-sortable" style="">
                        ...
                        <div class="ibox-content">
                            <div class="row">
                                ...
                                <div class="col-sm-5">
                                    <?= $form->field($model, 'ctype', [
                                        'size' => 7,
                                        'labelOptions' => ['class' => 'col-sm-5 control-label']
                                    ])->dropDownList(Constants::getArticleCtype()); ?>
                                </div>
                            </div>
                            ...
                            <?= $form->field($model, 'tag')->textInput(['placeholder'=>'标签用逗号,隔开']); ?>
                            <?= $form->field($model, 'sort')->textInput(); ?>
                            <?php /*$form->field($model, 'updated_at')->widget(
                                DateTimePicker::className(), [// inline too, not bad
                                'inline' => false, // modify template for custom rendering
                                //'size' => 'ms',
                            ...
                            <?= $form->field($model, 'created_at')->date(['type' =>'datetime']) ?>
