            ...
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content no-padding">
                    <ul class="list-group">
                        ...
                        <li class="list-group-item">
                            <span class="badge badge-primary">&nbsp;&nbsp;</span><strong>Yii</strong>: <?= yii::$app->getVersion() ?>
                        </li>
                        <li class="list-group-item ">
                        ...
                        <li class="list-group-item">
                            ...
                            <strong><?= Yii::t('app', 'PHP Info') ?></strong>: <?= $info['PHP_INFO'] ?>
                        </li>
                        <li class="list-group-item">
                            <span class="badge badge-success">&nbsp;&nbsp;</span>
                ...
                <div>
                    <div class="feed-activity-list">
                        ...
                        foreach ($comments as $comment) {
						 			$userAvatar = User::findByUsername($comment->nickname)['avatar'];
									if(!$userAvatar){
										$userAvatar = '/admin/static/img/default.png';
									}
                            ?>
                            <div class="feed-element">
                                <a class="pull-left"><img alt="image" class="img-circle" src="<?= $userAvatar ?>"></a>
