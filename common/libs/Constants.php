...
class Constants
{
    ...
    public static function getArticleCtype($key = null)
    {
        $items = [
            self::ARTICLE_TYPE_BLOG => yii::t('app', 'Blog'),
            self::ARTICLE_TYPE_COURSE => yii::t('app', 'Course'),
            self::ARTICLE_TYPE_NOTE => yii::t('app', 'Note'),
            self::ARTICLE_TYPE_SHARE => yii::t('app', 'Share'),
        ];
        return self::getItems($items, $key);
    }
