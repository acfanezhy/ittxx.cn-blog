...
+(function (a) {
    a(document).ready(function () {
        ...
        a.fn.postShare = function () {
            //a(this).addClass("actived");
            var z = a(this).data("id"), y = a(this).data("action"), x = a("span.action-share").children(".share_count");
            var w = {aid: z};
            //alert(z+'---'+y+'---'+x+'---'+w);
            w[a("meta[name=csrf-param]").attr('content')] = a("meta[name=csrf-token]").attr('content');
            a.post(a(this).attr('share-url'), w, function (A) {
                //alert(A);
                a(x).html(A)
            });
            jQuery.tipsBox({
                obj: a("span.action-share"), str: "+1", callback: function () {
                }
            });
            return false
        };
        a(document).on("click", "#Addshare", function () {
            a(this).postShare()
        });
        ...
        var m = "0", f = '<div class="comt-tip comt-loading">正在提交, 请稍候...</div>', c = '<div class="comt-tip comt-error">请填写点评论！</div>', b = '">提交成功', d = "取消编辑", o, k = 1, r = [];
        r.push("");
        ...
        a("#commentform").submit(function () {
            ...
            a.ajax({
                ...
                success: function (B) {
                    ...
                    a("#new_comm_" + k).fadeIn(2000);
                    //setTimeout(function(){ a("#new_comm_" + k).hide(); },3000); //自加隐藏
...
$(document).ready(function () {
		    ...
		    var config = {
		        ...
		        width: 2,
		        count: 100,		//点个数
		        color: "47,192,164", 	//点颜色
		        stroke: "47,192,164", 		//线条颜色
		        dist: 6000, 	//点吸附距离
    ...
    var withd_pp = document.body.offsetWidth;  //(包括边线和滚动条的宽)
    if (withd_p > 979) {
        $(window).scroll(function () {
            if ($(this).scrollTop() > 70) {   //整个头部高度115px，导航宽度45px
                //$("#nav-header").addClass("shadow");  // 头部固定样式
                $("#site-nav-wrap").addClass("shadows");
                $(".nav-searchs").css("display","block");
                $("#search-main").css("top","50px");
            } else {
                //$("#nav-header").removeClass("shadow");
                $("#site-nav-wrap").removeClass("shadows");
                $(".nav-searchs").css("display","none");
                $("#search-main").css("top","120px");
    ...
    $(".nav-search_1").click(function () {
        /*$(window).scroll(function () {
            if ($(this).scrollTop() > 70) {
                $(".nav_sj").css("margin-top", "70px");
            } else {
                $(".nav_sj").css("margin-top", "0px");
            }
        })*/
        /*if ($(".nav_sj").css("display") == 'none') {
        ...
        if ($("#site-nav-wrap").css("display") == 'none') {
            $("#site-nav-wrap").css("display", "block");
            $(".fa-navicon").attr("class", "fa fa-times");
            $(".right_0").attr("class", "right_70");
			//$("#wowslider-container1").css("margin-top", "0px");
			//$("#headline").css("margin-top", "0px");
			//$(".content-wrap").css("margin-top", "10px");
			$("#site-nav-wrap").css("margin-top", "70px");
        } else {
            $("#site-nav-wrap").css("display", "none");
            $(".right_70").attr("class", "right_0");
            $(".fa-times").attr("class", "fa fa-navicon");
			//$("#wowslider-container1").css("margin-top", "70px");
			//$("#headline").css("margin-top", "70px");
			//$(".content-wrap").css("margin-top", "80px");
			$("#site-nav-wrap").css("margin-top", "0px");
        }
